...
const Header = ({ title, breakpoint = 768, ...props }: MenuProps) => {
  ...
  createEffect(() => {
    ...
    return () => {
      window.removeEventListener('resize', (e) => handleWindowResize(e))
  ...
  return (
    <header
      ...
      } left-0 z-30 w-full bg-white text-back-dark shadow-md dark:bg-back-dark dark:text-white`}>
      <div class="m-auto flex h-16 w-full max-w-layout items-center justify-between px-7">
